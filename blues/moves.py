...
class MetropolizedNCMCMove(MetropolizedMove):
    ...
    def __init__(self, atom_subset=None, context_cache=None, n_steps=1000, n_restart_attempts=4):
    ...
    def _after_integration(self, context, thermodynamic_state, sampler_state):
        ...
        final_positions = sampler_state.positions[self.atom_subset]
    ...
    def apply(self, thermodynamic_state, sampler_state, reporter):
        ...
        self._before_integration(context, integrator, thermodynamic_state, sampler_state)
            ...
            try:
                ...
                for n in range(1,self.n_steps+1):
                    ...
                    if n == rotation_step:
                        ...
                        proposed_positions = self._propose_positions(self.initial_positions)
        ...
        self._after_integration(context, thermodynamic_state, sampler_state)
...
class RandomLigandRotationMove(MetropolizedNCMCMove):
    ...
    def _propose_positions(self, positions):
        ...
        rand_quat = mdtraj.utils.uniform_quaternion(size=None, random_state=np.random.RandomState(seed=3134))
